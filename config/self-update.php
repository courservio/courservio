...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The value to decide whether it should update automatically.
    |
    */

    'auto_update' => env('SELF_UPDATER_AUTO_UPDATE', true),
    ...
    */
    ...
    'repository_types' => [
        'github' => [
            'type' => 'github',
            'repository_vendor' => env('SELF_UPDATER_REPO_VENDOR', 'courservio'),
            'repository_name' => env('SELF_UPDATER_REPO_NAME', 'courservio'),
            'repository_url' => '',
    ...
    */
    ...
    'notifications' => [
        ...
        'mail' => [
            ...
            'from' => [
                'address' => env('SELF_UPDATER_MAIL_FROM_ADDRESS', env('MAIL_FROM_ADDRESS')),
                'name' => env('SELF_UPDATER_MAIL_FROM_NAME', 'courservio Update'),
            ],
        ],
    ],
