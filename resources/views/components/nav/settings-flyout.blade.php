...
@php use App\Models\CertTemplate;use App\Models\CourseType;use App\Models\Price;use App\Models\Role;use App\Models\Team;use App\Models\User; @endphp
<div x-show="settings"
        ...
        <nav class="grid gap-y-10 bg-white px-4 py-8 sm:grid-cols-2 sm:gap-x-8 sm:py-12 sm:px-6 lg:px-8 xl:pr-12"
            ...
            <div>
                ...
                <ul role="list" class="mt-5 space-y-6">
                        ...
                        <li class="flow-root">
                            <a href="{{ route('coursetype') }}"
                               class="-m-3 flex items-center rounded-md p-3 text-base font-medium text-gray-900 transition duration-150 ease-in-out hover:bg-gray-50">
                                ...
                                <svg class="h-6 w-6 flex-shrink-0 fill-gray-400" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 640 512">
                    ...
                    @can('viewAny', CertTemplate::class)
                        <li class="flow-root">
                            <a href="{{ route('certTemplates') }}"
                               class="-m-3 flex items-center rounded-md p-3 text-base font-medium text-gray-900 transition duration-150 ease-in-out hover:bg-gray-50">
                                <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com - Copyright 2022 Fonticons, Inc. -->
                                <svg class="h-6 w-6 flex-shrink-0 fill-gray-400" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 384 512">
