...
@component('mail::message')
    ...
    **{{ _i('Course details') }}**
    ...
    {{ Carbon::parse($course->start)->isoFormat('dd. DD.MM.YYYY') }} {{ Carbon::parse($course->start)->isoFormat('HH:mm') }} - {{ Carbon::parse($course->end)->isoFormat('HH:mm') }}
    ...
    **{{ _i('price') }}**\
    {{ Price::SIGN[$participant->currency] }} {{ $participant->price_gross }}
