                ...
                <div class="flex h-16 justify-between">
                    <div class="flex px-2 lg:px-0">
                        ...
                        <nav aria-label="Global" class="hidden lg:ml-6 lg:flex lg:items-center lg:space-x-4">
                            <a href="{{ route('home') }}"
                               class="px-3 py-2 text-sm font-medium text-gray-900">Dashboard</a>

                            <a href="{{ route('course') }}"
                               class="px-3 py-2 text-sm font-medium text-gray-900">{{ _i('Courses') }}</a>

                            @can('viewAny', Participant::class)
                                <a href="#"
                                   class="px-3 py-2 text-sm font-medium text-gray-900">{{ _i('participants') }}</a>
                            @endcan
                    ...
                    <div class="flex items-center lg:hidden">
                        ...
                        <button type="button"
                                ...
                                @click="open = true" aria-expanded="false" x-bind:aria-expanded="open.toString()">
                    ...
                    <div class="lg:hidden">
                        ...
                        <div x-show="open"
                             ...
                             class="fixed inset-0 z-20 bg-black bg-opacity-25" aria-hidden="true"
                            ...
                            <div class="divide-y divide-gray-200 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                                <div class="pt-3 pb-2">
                                    <div class="flex items-center justify-between px-4">
                                        ...
                                        <div class="-mr-2">
                                            <button type="button"
                                                    ...
                                                    @click="open = false" aria-expanded="false"
                                    ...
                                    <div class="mt-3 space-y-1 px-2">
                                        <a href="{{ route('home') }}"
                                           class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800">Dashboard</a>

                                        <a href="{{ route('course') }}"
                                           class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800">{{ _i('Courses') }}</a>

                                        @can('viewAny', Participant::class)
                                            <a href="#"
                                               class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800">{{ _i('participants') }}</a>
                                        @endcan
                                ...
                                <div class="pt-4 pb-2">
                                    ...
                                    <div class="mt-3 space-y-1 px-2">
                                        ...
                                        <a href="#" @click.prevent="window.livewire.emit('logout')"
                                           class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800">{{ _i('Logout') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="hidden lg:ml-4 lg:flex lg:items-center">
                        <button type="button"
                                class="flex-shrink-0 rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            <span class="sr-only">View notifications</span>
                            <!-- Heroicon name: outline/bell -->
                        ...
                        <!-- Profile dropdown -->
                        <div x-data="{ profileDropdown: false }" @click.outside="profileDropdown = false"
                             class="relative ml-4 flex-shrink-0">
                            <div>
                                <button type="button" @click="profileDropdown = !profileDropdown"
                            ...
                            <div x-show="profileDropdown"
                                ...
                                <a href="#" @click.prevent="window.livewire.emit('logout')"
                                   ...
                                   id="user-menu-item-2">{{ _i('Logout') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 py-3">
                    <nav class="flex" aria-label="Breadcrumb">
                        <div class="flex sm:hidden">
                            <a href="{{ url($breadcrumb_back['link']) }}"
                                    ...
                                    <li>
                                        <div class="flex items-center">
                                            ...
                                            <a href="{{ url($breadcrumb['link']) }}"
                                               class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">{{ _i($breadcrumb['text']) }}</a>
                                        </div>
                                    </li>
                                @endforeach
