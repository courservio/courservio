                ...
                @foreach($templates as $template)
                    <tr>
                        ...
                        <td class="py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                            @can('update', $template)
                                <x-button.link wire:click="edit({{ $template->id }})"><i
            ...
            <x-slot name="content">
                <div class="space-y-3">
                    <div>
                        ...
                        @else
                            <p class="mt-2 text-xs text-gray-500"
                               id="title-description">{{ _i('the template title') }}</p>
                            @enderror
                    </div>
                    ...
                    <div>
                        ...
                        @else
                            <p class="mt-2 text-xs text-gray-500"
                               id="description-description">{{ _i('A description for this template.') }}</p>
                            @enderror
                    </div>

                    <div>
                        <label for="description"
                               class="block text-sm font-medium text-gray-700">{{ _i('Template File') }}</label>
                        <div class="relative mt-1 rounded-md text-center shadow-sm">
                        ...
                        @else
                            <p class="mt-2 text-xs text-gray-500"
                               id="description-description">{{ _i('The Template File') }}</p>
                            @enderror
                    </div>
